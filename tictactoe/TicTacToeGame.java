...
public class TicTacToeGame {
    ...
    public static void main(String[] args) {
        ...
        gameObject.initialiseGame();
        if (gameObject.toss() == 1)
            System.out.println("\nPlayer won the toss.\nPlayer plays first.");
        else
            System.out.println("\nComputer won the toss.\nComputer plays first.");
        gameObject.choosePlayerLetter();
        gameObject.showBoard();
        gameObject.playerPlays();
        gameObject.showBoard();
        gameObject.checkWinOrTie();
        gameObject.displayResults();
        gameObject.computerPlays();
        gameObject.generateRandomMove();
        gameObject.generateWinningMove();
        gameObject.blockPlayersMove();
        gameObject.playersTurn();
        gameObject.computersTurn();
        gameObject.startGame();
        gameObject.continueTillGameOver();
        gameObject.playGame();
        gameObject.playAnotherGame();;
